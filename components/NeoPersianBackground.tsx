        ...
        <defs>
          ...
          >
            ...
            >
              ...
              <circle cx="50" cy="50" r="2.5" fill="var(--color-primary-neon)" />
              <circle cx="25" cy="25" r="1.5" fill="var(--color-primary-neon)" />
              <circle cx="75" cy="25" r="1.5" fill="var(--color-primary-neon)" />
              <circle cx="25" cy="75" r="1.5" fill="var(--color-primary-neon)" />
              <circle cx="75" cy="75" r="1.5" fill="var(--color-primary-neon)" />
              <circle cx="50" cy="0" r="1.5" fill="var(--color-primary-neon)" />
              <circle cx="100" cy="50" r="1.5" fill="var(--color-primary-neon)" />
              <circle cx="50" cy="100" r="1.5" fill="var(--color-primary-neon)" />
